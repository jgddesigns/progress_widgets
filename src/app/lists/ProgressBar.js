...
export default function ProgressBar (props) {
    ...
    const [CurrentPosition, setCurrentPosition] = React.useState(props.Type == "bar" ? 100 : props.LengthValue ?  props.LengthValue : 10)
    const [CurrentColor, setCurrentColor] = React.useState(null) 


    const base_states = {"restart": [Restart, setRestart], "current_position": [CurrentPosition, setCurrentPosition], "length_value": [props.Type == "bar" ? 100 : props.LengthValue ?  props.LengthValue : 10], "current_color": [CurrentColor ? CurrentColor : ["red", "yellow", "green"], setCurrentColor], "size": props.Size ? props.Size : "3", "trigger": props.Trigger, "trigger_amount": props.TriggerAmount, "style": props.Type =="symbols" ? props.Style ? props.Style : "circles" : "squares"} //set to null when other components are created
